# Assignment 3 - Tobacco mosaic virus genome data
...
```sh
git clone https://github.com/Bismarkacquah/appbio-2026.git
cd appbio-2026/week3
make
```

If the repository is already cloned, navigate to the `week3` directory and run:
